...
AccountSetting(
    ...
    Setting('setting_info', 'school', '', 'text', 'School', null, FLAG_DISABLED),
    Setting('setting_info', 'studentId', '', 'text', 'Student ID', null, FLAG_DISABLED),
...
DomainUserSetting(
    Setting('setting_info', 'displayName', '', 'text', 'Display Name', null, FLAG_DISABLED),
